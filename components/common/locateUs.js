...
const locations = [
    ...
    },
    {
        ...
        address: '720 Seneca St Ste 107 Seattle, WA 98101',
        phone: '+82790961000',
        image: 'australia.png',
        alt: 'Brain Inventory Western Australia Office: 720 Seneca St Ste 107 Seattle, WA 98101',
    }
]
        ...
        <>
            <div className="grid grid-cols-2 gap-2 mb-6 items-start">
                <div className="relative place-self-center">
                    <img src={'https://braininventory.s3.us-east-2.amazonaws.com/images/' + info.image} loading="lazy" alt={info.alt} width={138} height={167} ></img>
                </div>
