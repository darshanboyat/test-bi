        ...
        <div className="container">
          <div>
            ...
            <p className="mb-8">
              ...
              delivering the best-in-class solutions at a competitive cost
              across the globe. Here’s why we can be the best choice when it
              comes to building mobile apps:
            </p>
          </div>
          <div className="lg:grid lg:grid-cols-4 gap-0">
            <div className="bg-development-simply-culture mb-4 lg-mb-0">
              ...
              <p>
                ...
                user-friendly, scalable, secure, and new business solutions as
                per your need.
              </p>
            </div>
            ...
            <div className="bg-development-simply-culture mb-4 lg-mb-0">
              ...
              <p>
                We respect your ideas and vision, provide you every small
                project detail regularly, and consider your worthy advice when
                and as needed.
              </p>
            </div>
          </div>
